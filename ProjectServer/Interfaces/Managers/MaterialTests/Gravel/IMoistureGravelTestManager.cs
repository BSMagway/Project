...
namespace ProjectServer.Interfaces.Managers.MaterialTests.Gravel
{
    ...
    public interface IMoistureGravelTestManager
    {
        ...
        public Task<MoistureGravelTest> GetAsync(int moistureGravelTestId);
        ...
        public Task<MoistureGravelTest> AddAsync(MoistureGravelTest moistureGravelTest);
        ...
        public Task<bool> UpdateAsync(MoistureGravelTest moistureGravelTest);
