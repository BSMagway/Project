...
namespace ProjectServer.Managers.MaterialTests.Gravel
{
    ...
    public class BulkDensityGravelTestManager : IBulkDensityGravelTestManager
    {
        ...
        private readonly ILogger<BulkDensityGravelTestManager> _logger;
        ...
        public BulkDensityGravelTestManager(AppDbContext appDb, IDimensionManager dimensionManager, ICustomerManager customerManager, ILogger<BulkDensityGravelTestManager> logger)
        {
            _appDb = appDb;
