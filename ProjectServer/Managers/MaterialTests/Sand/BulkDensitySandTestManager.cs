...
namespace ProjectServer.Managers.MaterialTests.Sand
{
    ...
    public class BulkDensitySandTestManager : IBulkDensitySandTestManager
    {
        ...
        private readonly ILogger<BulkDensitySandTestManager> _logger;
        ...
        public BulkDensitySandTestManager(AppDbContext appDb, IDimensionManager dimensionManager, ICustomerManager customerManager, ILogger<BulkDensitySandTestManager> logger)
        {
            _appDb = appDb;
