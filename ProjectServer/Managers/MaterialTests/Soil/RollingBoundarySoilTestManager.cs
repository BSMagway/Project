...
namespace ProjectServer.Managers.MaterialTests.Soil
{
    ...
    public class RollingBoundarySoilTestManager : IRollingBoundarySoilTestManager
    {
        ...
        private readonly ILogger<RollingBoundarySoilTestManager> _logger;
        ...
        public RollingBoundarySoilTestManager(AppDbContext appDb, IDimensionManager dimensionManager, ICustomerManager customerManager, ILogger<RollingBoundarySoilTestManager> logger)
        {
            _appDb = appDb;
